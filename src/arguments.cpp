...
cxxopts::Options Arguments::setupArguments()
{
    ...
    options.add_options("Pokročilé")
        ...
        ("L,Blbost", "Pravděpodobnost, že je člověk s elektromobilem blbý a nemůže nabíjet auto doma", cxxopts::value<double>()->default_value("0.0"))
        ...
        ("W,Work","pRacovní doba v minutách (střední hodnota, rozptyl)", cxxopts::value<std::vector<double>>()->default_value("480,60"));
    return options;
}